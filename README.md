...
docker run -d \
  ...
  -e SCHEMA_REGISTRY_KAFKASTORE_TIMEOUT_MS=30000 \
  -e SCHEMA_REGISTRY_KAFKASTORE_INIT_TIMEOUT_MS=60000 \
  -e SCHEMA_REGISTRY_LOG4J_ROOT_LOGLEVEL=DEBUG \
  -e SCHEMA_REGISTRY_LOG4J_LOGGERS=io.confluent.kafka.schemaregistry=DEBUG \
